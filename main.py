...
h = 0.5
kde_results = {}
# if you wanted to use different heights or different hyperparameters put into a loop and append results here 
# analysis showed though that there was no difference in heights so we are not including and leaving height as a static 0.5
